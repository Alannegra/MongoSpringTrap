...
public class UserResource {
    ...
    @PostMapping("{id}")
    public void addAnimalOnUser(@RequestBody Animal animal, @PathVariable("id") int id){
        userController.addAnimal(animal,id);
    }
    ...
    public void delete(@PathVariable("id") int id, @PathVariable("index") int index){
        userController.deleteAnimalOnUser(id,index-1);
    }
